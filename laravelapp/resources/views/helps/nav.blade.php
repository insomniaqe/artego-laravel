    ...
    <div class="container">
        ...
        <div class="nav__menu">
            <ul>
                ...
                <li><a class="modal__abonement" href=""><img src="./img/icons/icon-nav-abonement.svg"/> Абонементы</a>
                </li>
                ...
                <li><a class="modal__conditions" href=""><img src="./img/icons/icon-nav-contacts.svg"/> Попап - условия
                        вступления</a></li>
                <li><a class="modal__wine" href=""><img src="./img/icons/icon-nav-contacts.svg"/> Попап - цветная заявка</a>
                </li>
            </ul>
