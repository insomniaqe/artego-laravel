...
/***/ "./dev/modules/admin/addevent/index.js":
/*!*********************************************!*\
  !*** ./dev/modules/admin/addevent/index.js ***!
  \*********************************************/
/*! unknown exports (runtime-defined) */
...
$(document).ready(function(){
  ...
  const fileInputs = addEventForm.find('.addevent__file__input');
  fileInputs.each(function(item) {
    let fileInput = $(this);
    let fileInputLabel = $(this).next();
    let fileInputText = fileInputLabel.find('.addevent__file__text');

    fileInput.on('change', function(){
      let filesArray = $(this)[0].files;
      if (filesArray.length && filesArray.length > 0) {
        fileInputText.text(`Вы загрузили ${filesArray.length} файл`);
      } else {
        fileInputText.text(`Файл не выбран`);
      }
    })
  })
})
...
/***/ "./dev/modules/cabinet/news/index.js":
/*!*******************************************!*\
  !*** ./dev/modules/cabinet/news/index.js ***!
  \*******************************************/
/*! unknown exports (runtime-defined) */
...
const newsCabinetSlider = new Swiper('.news__list', {
  autoplay: {
    delay: 3000,
  },
...
const calendarSlider = new Swiper('.calendar__slider', {
  ...
  centeredSlides: true,
  navigation: {
    nextEl: '.calendar__swiper-next',
    prevEl: '.calendar__swiper-prev',
  },
  effect: 'fade',
  fadeEffect: {
    crossFade: true
...
$(document).ready(function() {
  let slidersCount = $('.calendar__slider .swiper-slide').length;
  const calendarTotal = $('#calendar__total');
  calendarTotal.text(slidersCount);

  $('.calendar__swiper-next').on('click', function() {
    let calendarIndex = calendarSlider.activeIndex;
    $('#calendar__current').text(calendarIndex+1);
  });
  $('.calendar__swiper-prev').on('click', function() {
    let calendarIndex = calendarSlider.activeIndex;
    $('#calendar__current').text(calendarIndex+1);
  });
})
...
$(document).ready(function(){
  const footerSocialWhatsapp = $('.footer__social a.social__whatsapp');
  const footerSocialInstagram = $('.footer__social a.social__instagram');
  const footerSocialVK = $('.footer__social a.social__vk');

  function changeImg(link, src) {
    let img = link.find('img');
    img.attr('src', src);
  }

  footerSocialWhatsapp.on('mouseenter', function(){
    let link = $(this);
    changeImg(link, 'img/icons/icon-footer-whatsapp-red.svg');
  });
  footerSocialWhatsapp.on('mouseleave', function(){
    let link = $(this);
    changeImg(link, 'img/icons/icon-footer-whatsapp.svg');
  });

  footerSocialInstagram.on('mouseenter', function(){
    let link = $(this);
    changeImg(link, 'img/icons/icon-footer-instagram-red.svg');
  });
  footerSocialInstagram.on('mouseleave', function(){
    let link = $(this);
    changeImg(link, 'img/icons/icon-footer-instagram.svg');
  });

  footerSocialVK.on('mouseenter', function(){
    let link = $(this);
    changeImg(link, 'img/icons/icon-footer-vk-red.svg');
  });
  footerSocialVK.on('mouseleave', function(){
    let link = $(this);
    changeImg(link, 'img/icons/icon-footer-vk.svg');
  });
});
...
$(document).ready(function(){
  $(`#loginForm`).validate({
    ...
    messages: {
      ...
      login_email: {
        required: "Заполните поле!",
        email: "Введите адрес в правильном формате"
      }
    },
    submitHandler: function(form){
      let loginPassword = $(`#loginForm input[name=login_password]`).val();
      let loginEmail = $(`#loginForm input[name=login_email]`).val();
      let subscribeUrl = $(`#loginForm`).attr(`data-subscribe`);
      $.ajax({
        type: "POST",
        url: subscribeUrl,
...
$(document).ready(function(){
  $('#navMenuLink').on('click', function(){
    ...
    $(this).toggleClass('nav__left__link--active')
  });
});
...
/***/ "./dev/modules/orderform/index.js":
/*!****************************************!*\
  !*** ./dev/modules/orderform/index.js ***!
  \****************************************/
/*! unknown exports (runtime-defined) */
  ...
  $('#orderForm').validate({
    ...
    messages: {
      ...
      order_phone: {
        ...
        digits: "Допустим ввод только цифр!"
      }
    },
    submitHandler: function(form){
      let orderName = $(`#orderForm input[name=order_name]`).val();
      let orderPhone = $(`#orderForm input[name=order_phone]`).val();
      let subscribeUrl = `http://localhost:3000`;
      $.ajax({
        type: "POST",
        url: subscribeUrl,
...
/***/ "./dev/modules/possibilities/index.js":
/*!********************************************!*\
  !*** ./dev/modules/possibilities/index.js ***!
  \********************************************/
/*! unknown exports (runtime-defined) */
...
const possibilitiesSlider = new Swiper('.possibilities__slider', {
  slidesPerView: 1,
  centeredSlides: true,
  navigation: {
    nextEl: '.possibilities__swiper-next',
    prevEl: '.possibilities__swiper-prev',
  },
  effect: 'fade',
  fadeEffect: {
    crossFade: true
...
$(document).ready(function() {
  ...
  const possibilitiesTotal = $('#possibilities__total');
  possibilitiesTotal.text(slidersCount);

  $('.possibilities__swiper-next').on('click', function() {
    let possibilitiesIndex = possibilitiesSlider.activeIndex;
    $('#possibilities__current').text(possibilitiesIndex+1);
  });
  $('.possibilities__swiper-prev').on('click', function() {
    let possibilitiesIndex = possibilitiesSlider.activeIndex;
    $('#possibilities__current').text(possibilitiesIndex+1);
  });
});
...
$(`.modal__conditions`).on(`click`, function (evt) {
  ...
  $(`.conditions__modal`).fadeIn();
      ...
      $(`.modal__registration`).on(`click`, function (evt) {
        evt.preventDefault();
        $(`.modal`).fadeOut();
        $(`.registration__modal`).css('display', 'flex');
        $(`.registration__modal`).hide();
        $(`.registration__modal`).fadeIn();
      });
...
/******/ 	__webpack_require__("./dev/modules/nav/index.js");
/******/ 	__webpack_require__("./dev/modules/login/index.js");
/******/ 	__webpack_require__("./dev/modules/topslider/index.js");
/******/ 	__webpack_require__("./dev/modules/possibilities/index.js");
/******/ 	__webpack_require__("./dev/modules/calendar/index.js");
/******/ 	__webpack_require__("./dev/modules/tours/index.js");
